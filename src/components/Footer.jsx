    ...
    <footer className="bg-primary-dark text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {quickLinks.map((link) => (
                <li key={link.name}>
                  <Link href={link.href} className="text-neutral-300 hover:text-primary-light transition-colors">
                    {link.name}
                  </Link>
                </li>
              ))}
          ...
          <div>
            <h4 className="font-display font-semibold text-lg mb-4">Nutraceuticals</h4>
            <ul className="space-y-3">
          ...
          {/* Products - Cosmetics */}
          <div>
            <h4 className="font-display font-semibold text-lg mb-4">Cosmetics</h4>
            <ul className="space-y-3">
      ...
      <div className="border-t border-white/10">
        <div className="container py-6">
          <p className="text-center text-neutral-400 text-sm mb-4">Certified Excellence</p>
        ...
        <div className="container py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-neutral-400 text-sm">
              © {currentYear} Zeovus Life. All rights reserved.
            </p>
