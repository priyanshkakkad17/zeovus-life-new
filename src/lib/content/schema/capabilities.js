      ...
      fields: [
        {
          ...
          label: 'Heading',
          type: 'textarea',
          default: 'Where formulation science\nmeets real-world performance',
        },
        {
          id: 'intro',
        ...
        },
        {
          ...
          default: [
            ...
            'Liposomal, nanoemulsion and microencapsulation systems for bioavailability and stability',
            'Biomimetic emulsion design and sensory/texture optimisation',
            'Continuous evaluation of next-gen actives, fermentation-derived, postbiotic complexes',
          ],
        },
        { id: 'testingHeading', label: 'List 2 heading', type: 'text', default: 'Testing & Validation' },
        {
          ...
          itemLabel: 'Item',
          default: [
            'Compatibility and accelerated-ageing studies for every batch',
            'Particle size, encapsulation efficiency and release-profile testing at every stage',
            'Pilot-batch trials before scale-up',
          ],
        },
        {
          id: 'quote',
    ...
    },
    {
      ...
      fields: [
        ...
        { id: 'nutraHeading', label: 'Nutraceutical formats heading', type: 'text', default: 'Nutraceutical Formats' },
        {
          ...
          default: [
            { name: 'Hard-shell Capsules', desc: 'Two-piece capsule format for powders, blends and standardised extracts that dissolve once swallowed — a precise way to deliver the accurate dose every time.' },
            { name: 'Softgel Capsules', desc: 'One-piece, liquid-fill capsules for oils, omega-3s and fat-soluble actives that need a sealed, oxygen-protected format.' },
            { name: 'Tablets & Effervescents', desc: 'Compressed for consistency, formulated for fast or sustained release — including delayed and enteric-coated systems.' },
            { name: 'Chewable Tablets', desc: "No-water, easy-to-take tablets built for kids', senior and on-the-go supplement lines." },
            { name: 'Powders & Sachets', desc: 'Flexible dosing for actives, blends and functional nutrition, portioned for daily use.' },
            { name: 'Gummies', desc: 'High-potency gummies using microencapsulated actives, built for dose accuracy and taste.' },
            { name: 'Functional Liquids & Shots', desc: 'Fast-absorbing formats for actives that work best without a capsule or tablet.' },
            { name: 'Oral Dissolving Strips (ODF / Sublingual Films)', desc: 'Thin, fast-dissolving strips that deliver actives through the oral mucosa — no water, no swallowing.' },
            { name: 'Nutraceutical Patches (Transdermal)', desc: 'Skin-applied, daily patches that deliver vitamins and actives through sustained release.' },
            { name: 'Multi-Supplement Packs (Daily / AM-PM Packs)', desc: 'Different capsules, tablets and softgels pre-sorted into a single daily pouch — the full routine in one pack, no counting or sorting needed.' },
          ],
        },
        ...
        { id: 'cosmeticsHeading', label: 'Cosmetics formats heading', type: 'text', default: 'Cosmetics Formats' },
        {
          ...
          default: [
            { name: 'Creams & Lotions', desc: 'Hot- and cold-process emulsions built for heat-sensitive actives like peptides and biotech ingredients.' },
            { name: 'Serums & Gels', desc: 'Nanoemulsion and liposomal systems that help actives like retinol and vitamins perform on skin.' },
            { name: 'Balms & Sticks', desc: 'Concentrated, no-mess formats for targeted, on-the-go application.' },
            { name: 'Sprays & Mists', desc: 'Lightweight delivery for actives that need even, low-residue application.' },
            { name: 'Masks & Wipes', desc: 'Texture-led, sensory-driven formats using microencapsulated and biomimetic emulsion structures.' },
            { name: 'Shower Gels & Body Wash', desc: 'Everyday cleansing formats built on gentle, skin-compatible surfactant systems.' },
            { name: 'Shampoos & Conditioners', desc: 'Hair-care formats covering everyday, scalp-focused and treatment lines.' },
            { name: 'Bar & Liquid Soaps', desc: 'Classic and modern cleansing formats, formulated for skin-friendly pH and lather.' },
            { name: 'Sunscreens & Sun Care', desc: 'SPF creams, gels and sprays formulated for broad-spectrum protection and skin feel.' },
            { name: 'Body & Hair Oils', desc: 'Lightweight, fast-absorbing oils for daily nourishment across skin and hair.' },
            { name: 'Toothpaste & Oral Care Gels', desc: 'Whitening, sensitivity-relief and everyday formulas for daily oral hygiene.' },
          ],
        },
